...
class PartNetDataset(data.Dataset):
    ...
    def __init__(self, root, object_list, data_features, load_geo=False):
        ...
        self.img_root = root.replace("hier", "img")
    ...
    def __getitem__(self, index):
        ...
        img_path = os.path.join(self.img_root, self.object_names[index] + '.png')
        img = self.transforms(self.load_image(img_path))
        data_feats = ()
